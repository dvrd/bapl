...
local op_lambda = ID * token "=" * token "(" * token ")" * token "=>" * block / node("function", "name", "body")
local op_function = keyword "fn" * ID * token "(" * token ")" * block / node("function", "name", "body")
...
return p { "prog",
	...
	block = token "{" * stmts ^ 0 * token "}" / node("block", "body"),

	space = (loc.space + comments) ^ 0 * p(executionTracker),

	call  = ID * token "(" * token ")" / node("call", "name"),
